...
function init() {
	...
	if (document.forms["formGroup"] != undefined){
		checkMakeTable();
	}
	dropMenu();
	console.log("hello");
...
// this function verifies input for number checking and also makes table for multiple number check inputs
