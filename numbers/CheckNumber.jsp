...
<div style="overflow:auto">
 ...
 <div class="main-right">
	...
	<p>On this site you can find out does a subscriber number is assigned and if yes, who is the operator of the number
	...
	<form name="form1" action="NumberCheckResult.jsp" method="post" >
		...
		<br/>
			...
			<table id ="expand-Table" border="3"><tr><th>index</th><th>area code</th><th>number</th></tr></table>
