...
<div style="overflow:auto">
  <div class="menu">
    ...
    <div class="menuitem"><a href="#">Find numbers</a></div>
 ...
 <div class="main-right">
	...
	<p>On this site you can find out does the subscriber number exists and if it exists, who is the operator of the number
	
	</p>
	
	<form name="form1" action="NumberCheckResult.jsp" method="post" >
		<table>
			<tr><td>Network code: </td>
			<td>
				<select  name="net" >
		...
		<br/>
			...
			<table id ="expand-Table" border="3"><tr><th>red.br.</th><th>NDC</th><th>number</th></tr></table>
	...
	<table class="tbl-official" >
		<tr><td>Index</td><td>Network</td><td>Start of range</td><td>End of range</td><td>Operator</td></tr>
		<%
